...
Route::prefix('/six/backend/')->group(function () {
    ...
    Route::middleware(['auth:web'])->group(function () {
        ...
        Route::get('/documents/show/{id}', [DocumentController::class, 'object_documents']);
        /**
         * Маршруты отзывов
         */
        ...
        Route::post('/stage/create/reports/{stage_list}', [StageController::class, 'createReports'])
            ->middleware('role:3,1');
        Route::get('/stage/show/reports/{stage_list}', [StageController::class, 'showReports'])
            ->middleware('role:4,1,3');
         ...
         * Маршруты подъэтапов
         */
        Route::put('object/{work_list}/changeWorkStatus', [WorkController::class, 'completeWork']);
        ...
        Route::get('/object/{object}', [ObjectController::class, 'show'])->middleware('role:1,2,3,4');
        Route::get('/objects/my_objects', [ObjectController::class, 'my_objects']);
