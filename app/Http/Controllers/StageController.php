...
class StageController extends Controller
{
    ...
    public function createReports(Request $request, int $id)
    {
        return StageService::createReport($request, $id);
    }

    public function showReports(int $id)
    {
        return StageService::getReports($id);
    }
