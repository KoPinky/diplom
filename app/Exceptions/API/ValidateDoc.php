...
class ValidateDoc
{
    static public function validateDocument(array $input_data)
    {
        Validator::validate(
            $input_data, [
            'file.*' => 'required|mimetypes:image/png,image/jpg,image/x-ms-bmp,text/txt,application/msword,application/pdf,text/xml,application/vnd.openxmlformats-officedocument.wordprocessingml.document|max:20480'
        ], [
